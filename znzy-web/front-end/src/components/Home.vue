      ...
      >
        <div class="h-full overflow-y-auto scrollbar-hide">
          ...
          <div class="p-6 space-y-8 transition-opacity duration-300" :class="sidebarHovered ? 'opacity-100' : 'opacity-0'">
            ...
            <!-- 导航菜单 -->
            <nav class="space-y-2">
              <router-link to="/Home" class="flex items-center px-4 py-3 rounded-lg transition-colors duration-200"
                           :class="{'bg-primary/10 dark:bg-primary/20 text-primary dark:text-primary': $route.path === '/Home', 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700/50': $route.path !== '/Home'}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
                </svg>
                主页
              </router-link>
              <router-link to="/Article" class="flex items-center px-4 py-3 rounded-lg transition-colors duration-200"
                           :class="{'bg-primary/10 dark:bg-primary/20 text-primary dark:text-primary': $route.path === '/Article', 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700/50': $route.path !== '/Article'}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"></path>
                </svg>
                查看文章
              </router-link>
              <router-link to="/My" class="flex items-center px-4 py-3 rounded-lg transition-colors duration-200"
                           :class="{'bg-primary/10 dark:bg-primary/20 text-primary dark:text-primary': $route.path === '/My', 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700/50': $route.path !== '/My'}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                </svg>
                个人信息
              </router-link>
              <router-link to="/Plan" class="flex items-center px-4 py-3 rounded-lg transition-colors duration-200"
                           :class="{'bg-primary/10 dark:bg-primary/20 text-primary dark:text-primary': $route.path === '/Plan', 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700/50': $route.path !== '/Plan'}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                </svg>
                备忘录
              </router-link>
              <router-link to="/CreateArticle" class="flex items-center px-4 py-3 rounded-lg transition-colors duration-200"
                           :class="{'bg-primary/10 dark:bg-primary/20 text-primary dark:text-primary': $route.path === '/CreateArticle', 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700/50': $route.path !== '/CreateArticle'}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                </svg>
                发布文章
              </router-link>
              <router-link v-if="options.user.role==='管理员'" to="/Notice" class="flex items-center px-4 py-3 rounded-lg transition-colors duration-200"
                           :class="{'bg-primary/10 dark:bg-primary/20 text-primary dark:text-primary': $route.path === '/PublishNotice', 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700/50': $route.path !== '/PublishNotice'}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                </svg>
                发布通知
              </router-link>
              <router-link to="/NoticeList" class="flex items-center px-4 py-3 rounded-lg transition-colors duration-200 relative"
                           :class="{'bg-primary/10 dark:bg-primary/20 text-primary dark:text-primary': $route.path === '/NoticeList', 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700/50': $route.path !== '/NoticeList'}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                </svg>
                消息列表
              </router-link>
              <router-link to="/OpenAI" class="flex items-center px-4 py-3 rounded-lg transition-colors duration-200 relative"
                           :class="{'bg-primary/10 dark:bg-primary/20 text-primary dark:text-primary': $route.path === '/AIAssistant', 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700/50': $route.path !== '/AIAssistant'}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <router-link to="/Chart" class="flex items-center px-4 py-3 rounded-lg transition-colors duration-200 relative"
                           :class="{'bg-primary/10 dark:bg-primary/20 text-primary dark:text-primary': $route.path === '/DataAnalytics', 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700/50': $route.path !== '/DataAnalytics'}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                </svg>
                数据可视化
